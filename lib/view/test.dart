...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> downloadImage() async {
    String imageUrl = "https://i.imgflip.com/30b1gx.jpg";
  ...
  networkImg()async{
    var img =  Image.network("https://i.imgflip.com/30b1gx.jpg");
    var response =await http.get(Uri.parse("https://i.imgflip.com/30b1gx.jpg"));
